...
class  InstallCommand extends Command
{
    ...
    {
        (new Filesystem)->copy(__DIR__ . '/../stubs/Exceptions/AdminHandler.stub', app_path('Exceptions/AdminHandler.php'));
    ...
    public function facadeCopy()
    {
        ...
        (new Filesystem)->copy(__DIR__ . '/../stubs/Facades/Admin.stub', app_path('Facades/Admin.php'));
